...
// CREATE ENCODING
$encoding = new Encoding('ClearKey Encoding Example');
...
$cencDrm1080p = createCencDrm($cencDrmKey, $cencDrmKid, array($cencDrmEncodingOutput1080p));
$cencDrm720p = createCencDrm($cencDrmKey, $cencDrmKid, array($cencDrmEncodingOutput720p));
$cencDrm480p = createCencDrm($cencDrmKey, $cencDrmKid, array($cencDrmEncodingOutput480p));
$cencDrm360p = createCencDrm($cencDrmKey, $cencDrmKid, array($cencDrmEncodingOutput360p));
$cencDrm240p = createCencDrm($cencDrmKey, $cencDrmKid, array($cencDrmEncodingOutput240p));
...
$audioCencDrm128 = createCencDrm($cencDrmKey, $cencDrmKid, array($audioCencDrmEncodingOutput128));
