...
// CREATE ENCODING
$encoding = new Encoding('Widevine&Playready DRM Encoding Example');
...
$audioCencDrm128 = createCencDrm($cencDrmKey, $cencDrmKid, array($audioCencDrmEncodingOutput128), $widevinePssh, $playreadyLaUrl);
