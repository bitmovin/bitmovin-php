...
print 'TS audio Stream Id: ' . $streamAAC48000->getId() . "\n";
print 'TS audio Muxing Id: ' . $tsMuxingAAC48000->getId() . "\n";
print 'TS 1080p Stream Id: ' . $stream1080p->getId() . "\n";
print 'TS 1080p Muxing Id: ' . $tsMuxing1080p->getId() . "\n";
print 'TS 720p Stream Id: ' . $stream720p->getId() . "\n";
print 'TS 720p Muxing Id: ' . $tsMuxing720p->getId() . "\n";
print 'TS 480p Stream Id: ' . $stream480p->getId() . "\n";
print 'TS 480p Muxing Id: ' . $tsMuxing480p->getId() . "\n";
print 'TS 360p Stream Id: ' . $stream360p->getId() . "\n";
print 'TS 360p Muxing Id: ' . $tsMuxing360p->getId() . "\n";
print 'TS 240p Stream Id: ' . $stream240p->getId() . "\n";
