...
final class ApiUrls
{
    ...
    const ENCODING_MUXINGS_TS_DRM_AES = "encoding/encodings/{encoding_id}/muxings/ts/{muxing_id}/drm/aes";
    ...
    const OUTPUT_AKAMAI_NET_STORAGE = "encoding/outputs/akamai-netstorage";
